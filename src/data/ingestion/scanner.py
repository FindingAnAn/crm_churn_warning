...
from data.ingestion.adapters import (
    FSConfig,
    PostgresConfig,
    get_pg_conn,
    list_zip_files,
...
from data.ingestion.operations.naming import parse_zip_and_decide_names
...
def main() -> None:
    """Run one ingestion scan for a scheduler-managed execution."""
    logger.info("Starting incoming ZIP scan")
    run_once_scan()
    logger.info("Incoming ZIP scan completed")
